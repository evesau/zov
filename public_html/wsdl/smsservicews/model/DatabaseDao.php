...
const MAIL = "tecnico@airmovil.com";
const TEMA = 'SOAP Multiservice';
static $_instance;
static $_mysqli;
...
static $_mail;
    ...
    public static function getInstance($debug = false, $mail = false){
	...
	//load from config/config.ini
        $this->_dbHost = '10.186.188.188';
        $this->_dbUser = 'smsmkt';
        $this->_dbPassword = '231mktsms';
        $this->_dbName = 'sms';
        $this->_dbPort = 3306;
    ...
    public function queryOne($sql,$params = ''){
        ...
        if($params == ''){
            try{
                ...
                return array_shift($stmt->fetchAll());
            }catch(\PDOException $e){
		if(self::$_mail)
