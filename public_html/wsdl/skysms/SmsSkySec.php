...
XML;
    echo $xml;
    @mail("tecnico@airmovil.com","empty soap secure","soap vacio".print_r($_SERVER,1));
    exit();
}
*/
...
$server = new SoapServer("https://smsmkt.amovil.mx/wsdl/skysms/SmsSkySec.wsdl");
...
html;
	...
	mail("$tecnico", "Response error login", "Usuario: $Username - password: $PasswordDigest".print_r($response,1));
