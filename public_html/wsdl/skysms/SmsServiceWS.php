...
header("Content-Type: application/xml; charset=utf-8");	
	$headerResponse =<<<html
				<ns2:headerResponse>
					<ns1:codeError>00</ns1:codeError>
		            <ns1:messageError>Error favor de notificar</ns1:messageError>
		        </ns2:headerResponse>
html;
...
html;
	$campanias = SmsServiceWSDao::getAllCampaignCustomer(1);
	enviarMail('sendSms Service',$response,$campanias);
	echo $response;
	exit;
...
function enviarMail($accion='',$Data,$extraData){
