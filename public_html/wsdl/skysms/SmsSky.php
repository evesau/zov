...
XML;
    echo $xml;
    @mail("tecnico@airmovil.com","empty soap","soap vacio".print_r($_SERVER,1));
    exit();
}
*/
...
$server = new SoapServer("https://smsmkt.amovil.mx/wsdl/skysms/SmsSky.wsdl");
...
html;
		@mail("$tecnico","error login", "$user $pass");
	} else {
