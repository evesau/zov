...
class ReportesR implements Crud{
...
LEFT JOIN short_code sco USING ( short_code_id )
LEFT JOIN sms_campaign_estatus sce USING ( sms_campaign_estatus_id )
WHERE sc.campaign_id = :id AND (sc.msisdn_id LIKE "%$destination%" OR s.destination LIKE "%$destination%") AND (sce.estatus LIKE "%$estatus%" OR  s.status LIKE "%$estatus%")
GROUP BY sc.sms_campaign_id
LIMIT $start, $length
sql;
...
LEFT JOIN short_code sco USING ( short_code_id )
LEFT JOIN sms_campaign_estatus sce USING ( sms_campaign_estatus_id )
WHERE sc.campaign_id = :id AND (sc.msisdn_id LIKE "%$destination%" OR s.destination LIKE "%$destination%") AND sco.short_code LIKE "%$source%"
GROUP BY sc.sms_campaign_id
LIMIT $start, $length
sql;
...
LEFT JOIN short_code sco USING ( short_code_id )
LEFT JOIN sms_campaign_estatus sce USING ( sms_campaign_estatus_id )
WHERE sc.campaign_id = :id AND (sc.msisdn_id LIKE "%$destination%" OR s.destination LIKE "%$destination%") AND sco.short_code LIKE "%$source%" AND (sce.estatus LIKE "%$estatus%" OR  s.status LIKE "%$estatus%")
GROUP BY sc.sms_campaign_id
LIMIT $start, $length
sql;
...
LEFT JOIN short_code sco USING ( short_code_id )
LEFT JOIN sms_campaign_estatus sce USING ( sms_campaign_estatus_id )
WHERE sc.campaign_id = :id AND (sc.msisdn_id LIKE "%$destination%" OR s.destination LIKE "%$destination%") AND ca.name LIKE "%$carrier%"
GROUP BY sc.sms_campaign_id
LIMIT $start, $length
sql;
...
LEFT JOIN short_code sco USING ( short_code_id )
LEFT JOIN sms_campaign_estatus sce USING ( sms_campaign_estatus_id )
WHERE sc.campaign_id = :id AND (sc.msisdn_id LIKE "%$destination%" OR s.destination LIKE "%$destination%") AND ca.name LIKE "%$carrier%" AND (sce.estatus LIKE "%$estatus%" OR  s.status LIKE "%$estatus%")
GROUP BY sc.sms_campaign_id
LIMIT $start, $length
sql;
...
LEFT JOIN short_code sco USING ( short_code_id )
LEFT JOIN sms_campaign_estatus sce USING ( sms_campaign_estatus_id )
WHERE sc.campaign_id = :id AND (sc.msisdn_id LIKE "%$destination%" OR s.destination LIKE "%$destination%") AND ca.name LIKE "%$carrier%" AND sco.short_code LIKE "%$source%"
GROUP BY sc.sms_campaign_id
LIMIT $start, $length
sql;
...
sql;
	...
	public static function reportMTCop($id,$result, $start,$length){
		$mysqli = Database::getInstance();
		$query = <<<sql
SELECT ca.name AS "CARRIER", 
IF(s.status IS NULL , sce.estatus, s.status) AS "ESTATUSSMS",
...
LEFT JOIN sms_campaign_estatus sce USING ( sms_campaign_estatus_id )
LEFT JOIN campaign_customer cc ON cc.campaign_id = sc.campaign_id
WHERE cc.customer_id =$id_customer AND sc.campaign_id=$id_campania
GROUP BY sms_campaign_id
sql;
...
LEFT JOIN sms_campaign_estatus sce USING ( sms_campaign_estatus_id )
LEFT JOIN campaign_customer cc ON cc.campaign_id = sc.campaign_id
WHERE cc.customer_id =$id_customer AND sc.campaign_id=$id_campania AND sco.short_code LIKE '%$source%'
GROUP BY sms_campaign_id
sql;
