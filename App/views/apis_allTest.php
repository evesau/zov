...
<!-- /**********************TABLA DE NAVEGACION DE PETICIONES CURL Y PHP*********************************/ -->
              <div class="table-bordered">
                ...
                <div class="x_panel">
                  <div class="x_title">
                     <h2><i class="fa fa-bars"></i> Documentación <small>API https://smsmkt.amovil.mx/SendMt/sendGet</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
...
<!-- /**********************FIN TABLA DE NAVEGACION DE PETICIONES CURL Y PHP*********************************/ -->
            ...
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
            <strong>Importante!</strong>
              El Webhook debe contar con <strong>Basic Athentication</strong>
        </div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
