    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel tile fixed_height_240">
        ...
        <div class="x_content">
          ...
          <br><br>
          <form role="form" id="servicios" method="POST" action="/Reportesadmin/reporte_servicio">
            ...
            <div class="row" id="calendario" style="display:none;">
              <form role="form" id="servicedetalle" method="GET" action="/Reportesadmin/reporte_serviceDetalle">
            ...
            <div class="row" id="calendario2" style="display:none;">
              <form role="form" id="servicedetallefechas" method="GET" action="/Reportesadmin/reporte_serviceDetalleFechas">
                <div class="form-group row">
                    <br><br>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="dataTable_wrapper">
                  <table class="table table-striped table-bordered table-hover" id="reporte_admin_servicio">
                    <thead>
                      <tr>
                        <th>entry_time</th>
                        <th>source</th>
