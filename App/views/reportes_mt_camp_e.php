<?php echo $header; //echo "ver-->$ver"; ?>
<?php //if($ver==1){ $disable = ""; } else { $disable = "disabled='true'"; } //echo $disable; ?>
<?php $disable = ""; ?>
<!--/Header-->
<!--Body-->
  <div class="row">
                    ...
                    <div class="form-group">
                      <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        <div class="list-group">
                          ...
                          <select class="select2_single form-control" name="carrier" id="carrier">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                        <div class="list-group">
                          ...
                          <input class="form-control" id="loteid" name="loteid" type="text" <?php echo $disable; ?> />
                        </div>
                      </div>
                      <!--div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                        <div class="list-group">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                        <div class="list-group">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <button id="reporte" class="btn btn-success" type="button" style="width: 100%; height: 100%;">
                              <span class="glyphicon glyphicon-list-alt"></span> Descargar Detalle</button>
                          </div>
                          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <button id="enviar_mail" class="btn btn-dark" type="button" style="width: 100%; height: 100%;" <?php echo $disable; ?> >
                              <span class="glyphicon glyphicon-envelope"></span> Descargar x mail</button>
                          </div>
                        </div>
                      </div>                          
                    </div>
