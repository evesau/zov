            ...
            <div class="row" id="reportemt">
              <div lass="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="x_content">
                  ...
                  <label class="col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label">Selecciona la campaña de la que deseas generar el reporte. </label>
                  <br><br>
                  <form role="form" id="mt" method="POST" action="/Reportesmt/reporte_mt">
                        ...
                        <div class="col-md-6">
                          <div align="center">
                            ...
                            <span class="input-group-btn">
                              ...
                              <button id="reporte" type="submit" class="btn btn-primary">Descargar Detalle</button>
                            </span>
                          </div>
                        </div>
                        <!-- </div> -->
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <!-- Buscador -->
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="buscador">
                      <!-- <div class="col-md-10" role="main">
                        <div class="row top_tiles"> -->
                          <form role="form" id="buscarReportes" method="GET" action="/Reportes/searchDateReportMT">
                            <div class="form-group row">
                              <label class="form-group">Carrier:</label>
                            ...
                            <div class="col-xs-8 col-sm-12 col-md-12 col-lg-12">
                              <button onclick="actualizarDataTableSearchReportMT()" type="button" class="btn btn-primary pull-right">
