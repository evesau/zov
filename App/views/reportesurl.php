    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel tile fixed_height_240">
        <div lass="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <h1 class="page-header">Reporte MT Url</h1>
                  ...
                  <div class="form-group" id="shorcode">
                    ...
                    <div lass="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div>
                        ...
                        <select class="select2_single form-control" onChange="actualizarDataTable()" id="id_campania" name="reporte" aria-hidden="true">
