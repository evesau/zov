  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel tile fixed_height_240">
        <div class="col-lg-12">
          <h1 class="page-header"> Generar Reporte MO</h1>
          <div class="clearfix"></div>
        </div>
        <div class="x_content">
          <label class="col-md-12 control-label">Selecciona la campaña de la que deseas generar el reporte. </label>
          <br><br>
          <form role="form" id="mt" method="POST" action="/Reportesadmin/reporte_mo">
            ...
            <div class="row" id="calendario" style="display:none;">
              <form role="form" id="modetalle" method="POST" action="/Reportesadmin/reporte_moDetalle">
            ...
            <div class="row" id="calendario2" style="display:none;">
              <form role="form" id="modetallefechas" method="POST" action="/Reportesadmin/reporte_moDetalleFechas">
                <div class="form-group row">
                    <br><br>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="datable_wrappaTer">
                  <table class="table table-striped table-bordered table-hover" id="reportes_admin_mo">
                    <thead>
                      <tr>
                        <th>Fecha</th>
                        <th>Source</th>
