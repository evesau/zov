...
<!-- /**********************FIN TABLA DE NAVEGACION DE PETICIONES CURL Y PHP*********************************/ -->
                                    ...
                                    <div class="x_content">
                                      ...
                                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                          ...
                                          <li role="presentation" class=""><a href="#response" role="tab" id="response-tab-seg" data-toggle="tab" aria-expanded="false">Respuesta seguimiento</a>
                                          </li>
                                        </ul>
                                        <div id="myTabContent" class="tab-content">
    ...
    print_r(json_decode($response));
                                          ...
                                          <div role="tabpanel" class="tab-pane fade" id="response" aria-labelledby="home-tab-1" style="background: #2A3F54; color: white; border-radius: 5px; font-size: 12px;">
                                            <p class="lead" style="margin:20px;">Tipos de respuesta del seguimiento.</p>
                                            <pre>
    <strong>1. ACCEPTD:</strong> Confirmaci&oacute;n del carrier.
    <strong>2. Delivered:</strong> Entregado al carrier.
    <strong>3. Queued:</strong> Encolado.
    <strong>4. Blacklist:</strong> El n&uacute;mero se encuentra en lista negra.
    <strong>5. preparado para envio:</strong> Listo para enviar.
    <strong>6. Error:</strong> error en el carrier.
    <strong>7. Rejectd:</strong> Rechazado por el carrier.
                                            </pre>
                                            <br>
                                          </div>
                        ...
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <a href="/apis/add" type="button" class="btn btn-primary btn-circle"><i class="fa fa-plus"></i></a>
