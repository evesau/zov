    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel tile fixed_height_240">
        ...
        <div class="x_content">
          ...
          <br><br>
          <form role="form" id="servicios" method="POST" action="/Reportesadmin/reporte_campaniasFecha">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="dataTable_wrapper">
                  <table class="table table-striped table-bordered table-hover" id="reporte_admin_campania">
                    <thead>
                      <tr>
