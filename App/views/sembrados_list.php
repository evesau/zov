			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<form role="form" id="servicios" method="POST" action="/Sembrados/delete">
						<div class="buttons">
							<button type="button" id="delete" class="btn btn-danger btn-sm"><span class="fa fa-remove"> Eliminar </span></button>
							<button type="button" id="addMsisdn" class="btn btn-success btn-sm"><span class="fa fa-plus"> Agregar </span></button>
						</div>
