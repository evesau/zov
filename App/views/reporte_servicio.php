  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel tile fixed_height_240">
        <div class="col-lg-12">
          <h1 class="page-header"> Reporte Servicio SMS</h1>
            ...
            <div class="row" id="reportemt">
              <div class="col-lg-12">
                <div class="x_content">
                  ...
                  <br><br>
                  <form role="form" id="reporteExcel" method="POST" action="/Reportesmogeneral/generarExcelServicioSms" target="_blank">
                      ...
                      <div class="col-md-12 col col-sm-12">
                        <div>
                          <select class="form-control" id="campaign_id" name="campaign_id">
                            <option value="" disabled selected>Selecciona una Camapaña</option>
                              <?php echo $select; ?>
                          </select>
                        </div>
                        <div class="col-md-6">
                          <div align="center">
                            ...
                            <span class="input-group-btn">
                              <input class="btn btn-primary" type="submit" id="btnExcel" value="Descargar Excel">
                            </span>
                          </div>
                        </div>
                        <!-- </div> -->

                        <!-- BOTONES DE BUSQUEDA POR FECHA -->
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <h2  class="page-header"> Reporte MT Servicio</h2>
                    <!-- Buscador -->
