...
*/
    ...
    public static function descomprimirZip($fichero_subido){
        ...
        try{
            ...
            //mail('jorge.manon@airmovil.com', 'Test', 'Comando: '.$comando);
            //print_r($comando);
...
<section class="container">
        ...
        <section class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
            <h1>Lo sentimos, la secci&oacute;n que buscas ya no est&aacute; disponible.</h1>
...
html;
	...
	$json['acceso']['password'] = $pwd;
        ...
        $url = 'http://ws.amovil.mx:6654/'.$url;
...
mail('juan.medina@airmovil.com','envio json',"json: \n $json");
    ...
    public static function noAcentosSinArroba($string){
        $string = str_replace(
            array('á', 'à', 'ä', 'â', 'ª', 'Á', 'À', 'Â', 'Ä'),
            array('a', 'a', 'a', 'a', 'a', 'A', 'A', 'A', 'A'),
            $string
    ...
    public static function noAcentosSinArrobaRCS($string){
        //Esta parte se encarga de eliminar cualquier caracter extraño
        $string = str_replace(
        array("\\", "¨", "º", "~",
             "#", "", "|", "!", "\"",
